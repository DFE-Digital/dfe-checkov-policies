...
| DFE_ELZ_0006 | Enforce write-only network security groups on subnets               | Ensure that subnets are using write-only network security groups                                                                                                                     | Network    | Active |
| DFE_ELZ_0007 | Ensure standalone network security group associations are not used  | Ensure that subnets do not have a network security group association resource, as we prefer write-only network security groups in the subnet                                         | Network    | Active |
